...
! NoahMP.5 AMSR-E(NASA) soil moisture
   call registerlsmdainit(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_dasoilm_init)
   call registerlsmdagetstatevar(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_getsoilm)
   call registerlsmdasetstatevar(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_setsoilm)
   call registerlsmdagetobspred(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_getsmpred)
   call registerlsmdaqcstate(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_qcsoilm)
   call registerlsmdaqcobsstate(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_qc_soilmobs)
   call registerlsmdascalestatevar(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_scale_soilm)
   call registerlsmdadescalestatevar(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_descale_soilm)
   call registerlsmdaupdatestate(trim(LIS_noahmp50Id)//"+"//&
        trim(LIS_NASA_AMSREsmobsId)//char(0),NoahMP50_updatesoilm)
