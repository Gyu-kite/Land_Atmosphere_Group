...
!EOP
    ...
    do n=1,LIS_rc%nnest
       ...
       era5_struc(n)%nrold = 721  !720
       era5_struc(n)%npts = 1440*721 !340819
       era5_struc(n)%mo1 = -1
       era5_struc(n)%mo2 = -1

         
       allocate(era5_struc(n)%tair1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248)) !745
       allocate(era5_struc(n)%qair1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%wind1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%ps1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%rainf1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%swd1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%lwd1(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))

       allocate(era5_struc(n)%tair2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%qair2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%wind2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%ps2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%rainf2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%swd2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
       allocate(era5_struc(n)%lwd2(LIS_rc%lnc(n)*LIS_rc%lnr(n),248))
